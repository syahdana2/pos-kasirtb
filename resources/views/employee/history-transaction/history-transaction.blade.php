                ...
                <div class="col-sm-12">
                  ...
                  <table id="example2" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td colspan="3"></td>
                        <td class="bg-warning" colspan="3">Total Subtotal: <b>Rp {{ number_format($totalSubtotal) }}</b></td>
                        <td class="bg-success" colspan="3">Total Laba: <b>Rp {{ number_format($totalProfit) }}</b></td>
                      </tr>
                      @else
                      <tr>
