      ...
      <div class="row">
        <div class="col-md-12 mt-4">
          ...
          <div class="card card-info">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('new_pelanggan') }}" method="post">
                @csrf
                <div class="form-group row mb-3 mx-1">
                  <label for="name" class="col-sm-2 col-form-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama pelanggan atau sales" required>
                  </div>
                </div>
                <div class="form-group row mb-3 mx-1">
                ...
                <div class="form-group row mb-3 mx-1">
                  ...
                  <div class="col-sm-10">
                    <textarea name="note" class="form-control" id="note" name="note" rows="3" placeholder="Masukkan catatan "></textarea>
                  </div>
                </div>
